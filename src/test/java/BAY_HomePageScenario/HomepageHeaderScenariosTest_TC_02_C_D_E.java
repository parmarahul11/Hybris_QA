...
public class HomepageHeaderScenariosTest_TC_02_C_D_E extends BaseClassBay {
	...
	/*
	 * @Test(dataProvider = "searchData") public void
	 * clickOnSearchBarAndSearchSomething(String data) throws InterruptedException {
	 * HomePage_EleBAY hp=new HomePage_EleBAY(driver); hp.sendTextOnSeachbar(data);
