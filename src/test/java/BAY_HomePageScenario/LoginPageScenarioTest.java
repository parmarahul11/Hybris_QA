...
public class LoginPageScenarioTest extends BaseClassBay {
	...
	public void loginToBAY() throws InterruptedException, AWTException {
		...
		driver.findElement(By.xpath("//input[@placeholder='E-mail address']"))
				.sendKeys("ratnadeep.khaple@sapours.co.in");
		// Thread.sleep(2000);
		// pass password
		driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("Bhavani$555");
		/*
		 * eckBox //select ch WebElement ele =
		 * driver.findElement(By.xpath("//span[@role='checkbox']"));
		 * wUtil.mouseHoverOn(driver, ele); Thread.sleep(2000);
		 * wUtil.clickUsingJSE(driver, ele); //click on sign in button
